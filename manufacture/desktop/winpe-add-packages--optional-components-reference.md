...
| Network/WinPE-WiFi-Package | WinPE-WiFi-Package is used by Windows Recovery Environment (Windows RE) for built-in recovery functions. This package is included in the base winre.wim file.<br><br> **Note:** Windows PE and Windows RE don't support general wireless networking functions. |
