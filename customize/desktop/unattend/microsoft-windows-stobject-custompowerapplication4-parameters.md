...
<td><p>Specifies the arguments to use when running the application specified by [CustomPowerApplication4](microsoft-windows-stobject-custompowerapplication4.md).</p>
